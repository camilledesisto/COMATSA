...
survey_all <- read.csv("./Data/seven_sites_lemurs2.csv")
...
allocebus_dat <- read.csv("./Data/allo_reps.csv")
...
#Upload covariate data 
microcebus_dat <- read.csv("./Data/micro_reps.csv")
#Manually fix some covariate data 
...
lmer_microcebus_best <- lmer_microcebus13
...
lmer_lepilemur_best <- lmer_lepilemur9 #rugedness has a significantly negative relationship with lepilemur density
...
lmer_avahi_best <- lmer_avahi13 #rugedness has a significantly negative relationship with avahi density, height is significantly positive, and forest loss proportion is marginally significantly positive
...
lmer_rubriventer_best <- lmer_rubriventer #Forest loss proportion is positively, significantly related to Eulemur rubriventer density 
...
lmer_albifrons_best <-lmer_albifrons
...
lmer_hapalemur_best <- lmer_hapalemur6
