...
library(Distance); library(tidyverse); library(lme4); library(lmerTest); library(rsq); library(ggplot2)

#Import relevant data 
survey_all <- read.csv("~/Documents/MadaResearch/COMATSA/lemur_surveys/seven_sites_lemurs2.csv")
#Make separate data frames for dirunal and nocturnal lemurs
survey_diurnal <- survey_all %>% filter(Type=="Diurnal"&Site =="Ambodivoara"|Site=="Ambodivohitra_Kobahina")
survey_nocturnal <- survey_all %>% filter(Type=="Nocturnal"&Site =="Ambodivoara"|Site=="Ambodivohitra_Kobahina")
...
#Nocturnal
survey_nocturnal$Effort[survey_nocturnal$Transect=="1"& survey_nocturnal$Site=="Ambodivoara"] <- 860 * 13
survey_nocturnal$Effort[survey_nocturnal$Transect=="2"& survey_nocturnal$Site=="Ambodivoara"] <-1000 * 15
survey_nocturnal$Effort[survey_nocturnal$Transect=="3"& survey_nocturnal$Site=="Ambodivoara"] <- 1000 * 10
survey_nocturnal$Effort[survey_nocturnal$Transect=="4"& survey_nocturnal$Site=="Ambodivoara"] <-1000 * 12
...
#Diurnal
survey_diurnal$Effort[survey_diurnal$Transect=="1"& survey_diurnal$Site=="Ambodivoara"] <- 860 * 13
survey_diurnal$Effort[survey_diurnal$Transect=="2"& survey_diurnal$Site=="Ambodivoara"] <-1000 * 15
survey_diurnal$Effort[survey_diurnal$Transect=="3"& survey_diurnal$Site=="Ambodivoara"] <- 1000 * 10
survey_diurnal$Effort[survey_diurnal$Transect=="4"& survey_diurnal$Site=="Ambodivoara"] <-1000 * 12
...
gof_ds(model7_allocebus)#marginally significant
gof_ds(model8_allocebus)
gof_ds(model9_allocebus)

#Of the models without poor fit, compare AIC calues
AIC(model1_allocebus, model2_allocebus, model3_allocebus, model4_allocebus, model5_allocebus,  model7_allocebus, model8_allocebus,model9_allocebus)

#Plot the best-fitting model 
plot(model8_allocebus, nc=6)

#Get detection probability
allocebus_detection_prob <- predict(model8_allocebus)$fitted[[1]]
...
allocebus_dat$NObs[allocebus_dat$Site_Transect=="Ambodivoara_5"]<- 2
...
lmer_allocebus_best <- summary(lmer_allocebus9)
...
microcebus_df <- survey_nocturnal  %>% filter(Nom_sientifique=="Microcebus_mittermeieri") %>% select(Nom_sientifique, Site, Transect, Angle, Dis, Effort)
...
gof_ds(model4_microcebus)#marginally significant 
gof_ds(model5_microcebus)#significant
gof_ds(model6_microcebus)#marginally significant
gof_ds(model7_microcebus)#significant
gof_ds(model8_microcebus)
gof_ds(model9_microcebus)#significant

#Of the models without poor fit, compare AIC calues
AIC(model1_microcebus, model2_microcebus, model3_microcebus, model4_microcebus, model8_microcebus)
...
microcebus_dat$NObs[microcebus_dat$Site_Transect=="Befamatra_2"] <- microcebus_dat$NObs[microcebus_dat$Site_Transect=="Befamatra_2"] +1
microcebus_dat$NObs[microcebus_dat$Site_Transect=="Ambodivoara_5"]<- 2
...
lmer_microcebus_best <- summary(lmer_microcebus13)
...
#Of the models without poor fit, compare AIC calues
AIC(model1_cheirogaleus, model2_cheirogaleus, model3_cheirogaleus, model4_cheirogaleus,model5_cheirogaleus, model6_cheirogaleus,  model8_cheirogaleus, model9_cheirogaleus)
...
#Manually fix some covariate data 
cheirogaleus_dat$NRep <- 3
cheirogaleus_dat$NRep[cheirogaleus_dat$Site_Transect=="Befamatra_2"] <- 4
...
cheirogaleus_dat$NObs[cheirogaleus_dat$Site_Transect=="Befamatra_2"] <- cheirogaleus_dat$NObs[cheirogaleus_dat$Site_Transect=="Befamatra_2"] +1
...
lmer_cheirogaleus_best <- summary(lmer_cheirogaleus11) #forest loss proportion has a signifcantly positive relationship with Cheirogaleus density
...
gof_ds(model8_lepilemur)#marginally significant
gof_ds(model9_lepilemur)#significant,

#Of the models without poor fit, compare AIC calues
AIC(model1_lepilemur, model2_lepilemur, model3_lepilemur, model4_lepilemur,model5_lepilemur, model6_lepilemur,  model8_lepilemur)
...
lmer_lepilemur_best <- summary(lmer_lepilemur9) #rugedness has a significantly negative relationship with lepilemur density
...
gof_ds(model2_avahi)#marginally significant
...
lmer_avahi_best <- summary(lmer_avahi13) #rugedness has a significantly negative relationship with avahi density, height is significantly positive, and forest loss proportion is marginally significantly positive
...
rubriventer_df <- survey_diurnal  %>% filter(Nom_sientifique=="Eulemur_rubriventer"|Nom_sientifique=="Eulemur_albifrons"|Nom_sientifique=="Propithecus_candidus"|Nom_sientifique=="Hapalemur_occidentalis") %>% select(Nom_sientifique, Site, Transect, Angle, Dis, Effort)
...
#model6_rubriventer <- ds(rubriventer_df3, key="hr", adjustment="herm")#poor fit 
...
#Test goodness of fit for detection functions
gof_ds(model1_rubriventer)#marginally significant
gof_ds(model2_rubriventer)#marginally significant
gof_ds(model3_rubriventer)#marginally significant
gof_ds(model4_rubriventer)#significant
gof_ds(model5_rubriventer)#significant
#gof_ds(model6_rubriventer)
gof_ds(model7_rubriventer)#significant
gof_ds(model8_rubriventer)#marginally significant
gof_ds(model9_rubriventer)#significant

#Of the models without poor fit, compare AIC calues
AIC(model1_rubriventer, model2_rubriventer, model3_rubriventer, model8_rubriventer)

#Plot the best-fitting model 
plot(model8_rubriventer, nc=5)
...
rubri_dat$NObs[rubri_dat$Site_Transect=="Ambodivoara_5"]<- 2
...
lmer_rubriventer_best <- summary(lmer_rubriventer) #Forest loss proportion is positively, significantly related to Eulemur rubriventer density 
...
albifrons_df <- survey_diurnal  %>% filter(Nom_sientifique=="Eulemur_albifrons"|Nom_sientifique=="Eulemur_rubriventer"|Nom_sientifique=="Propithecus_candidus"|Nom_sientifique=="Hapalemur_occidentalis") %>% select(Nom_sientifique, Site, Transect, Angle, Dis, Effort)
...
#Test goodness of fit for detection functions
gof_ds(model1_albifrons)#marginally significant
gof_ds(model2_albifrons)#marginally significant
gof_ds(model3_albifrons)#marginally significant
gof_ds(model4_albifrons)#significant
gof_ds(model5_albifrons)#significant
#gof_ds(model6_albifrons)
gof_ds(model7_albifrons)#significant
gof_ds(model8_albifrons)#marginally significant
gof_ds(model9_albifrons)#significant

#Of the models without poor fit, compare AIC calues
AIC(model1_albifrons, model2_albifrons, model3_albifrons, model8_albifrons)

#Plot the best-fitting model 
plot(model8_albifrons, nc=5)
...
lmer_albifrons_best <- summary(lmer_albifrons)
...
propithecus_df <- survey_diurnal  %>% filter(Nom_sientifique=="Eulemur_rubriventer"|Nom_sientifique=="Eulemur_albifrons"|Nom_sientifique=="Propithecus_candidus"|Nom_sientifique=="Hapalemur_occidentalis") %>% select(Nom_sientifique, Site, Transect, Angle, Dis, Effort)
...
#Test goodness of fit for detection functions
gof_ds(model1_propithecus)#marginally significant
gof_ds(model2_propithecus)#marginally significant
gof_ds(model3_propithecus)#marginally significant
...
gof_ds(model8_propithecus)#marginally significant
...
prop_dat$NObs[prop_dat$Site_Transect=="Ambodivoara_5"]<- 2
...
lmer_propithecus_best <- summary(lmer_propithecus10)

```

```{r Hapalemur density calculations}
#Get data frame for just hapalemur
hapalemur_df <- survey_diurnal  %>% filter(Nom_sientifique=="Eulemur_rubriventer"|Nom_sientifique=="Eulemur_albifrons"|Nom_sientifique=="Propithecus_candidus"|Nom_sientifique=="Hapalemur_occidentalis") %>% select(Nom_sientifique, Site, Transect, Angle, Dis, Effort)
...
#Test goodness of fit for detection functions
gof_ds(model1_hapalemur)#marginally significant
gof_ds(model2_hapalemur)#marginally significant
gof_ds(model3_hapalemur)#marginally significant
gof_ds(model4_hapalemur)#significant
gof_ds(model5_hapalemur)#significant
#gof_ds(model6_hapalemur)
gof_ds(model7_hapalemur)#significant
gof_ds(model8_hapalemur)#marginally significant
gof_ds(model9_hapalemur)#significant

#Of the models without poor fit, compare AIC calues
AIC(model1_hapalemur, model2_hapalemur, model3_hapalemur, model8_hapalemur)

#Plot the best-fitting model 
plot(model8_hapalemur, nc=5)

#Get detection probability
hapalemur_detection_prob <- predict(model8_hapalemur)$fitted[[1]]
...
hapa_dat$NObs[hapa_dat$Site_Transect=="Ambodivoara_5"]<- 2
...
lmer_hapalemur_best <- summary(lmer_hapalemur6)
