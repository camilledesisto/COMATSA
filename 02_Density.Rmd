...
survey_all <- read.csv("~/Documents/MadaResearch/COMATSA/lemur_surveys/eight_sites_lemurs.csv")
...
#Test goodness of fit for detection functions
gof_ds(model1_microcebus)#marginally significant 
gof_ds(model2_microcebus)
gof_ds(model3_microcebus)#marginally significant 
...
gof_ds(model8_microcebus)#marginally significant
gof_ds(model9_microcebus)#significant

#Of the models without poor fit, compare AIC calues
AIC(model1_microcebus, model2_microcebus, model3_microcebus, model8_microcebus)

#Plot the best-fitting model 
plot(model2_microcebus, nc=6)
...
#Plot the best-fitting model 
plot(model7_cheirogaleus, nc=4)

#Get detection probability
cheirogaleus_detection_prob <- predict(model7_cheirogaleus)$fitted[[1]]
...
#Test goodness of fit for detection functions
gof_ds(model1_avahi)#marginally significant
gof_ds(model2_avahi)#marginally significant
gof_ds(model3_avahi)#marginally significant
gof_ds(model4_avahi)#marginally significant
gof_ds(model5_avahi)
...
#Of the models without poor fit, compare AIC calues
AIC(model1_avahi, model2_avahi, model3_avahi, model4_avahi, model5_avahi, model6_avahi, model8_avahi)

#Plot the best-fitting model 
plot(model5_avahi, nc=4)

#Get detection probability
avahi_detection_prob <- predict(model5_avahi)$fitted[[1]]
...
lmer_avahi_best <- lmer_avahi13 #rugedness has a significantly negative relationship with avahi density, height is significantly positive, and forest loss proportion is significantly positive
...
#Test goodness of fit for detection functions
gof_ds(model1_rubriventer)
gof_ds(model2_rubriventer)
gof_ds(model3_rubriventer)
...
lmer_propithecus_best <- lmer_propithecus12
