...
buffer_allo <- rbind(buffer_allo, buffer_allo7)
elevation_allo <- rbind(elevation_allo, elevation_allo7)
...
forest_loss_sum_allo <- rbind(forest_loss_sum_allo, forest_loss_sum_allo7)
rug_allo <- rbind(rug_allo, rug_allo7)
height_allo <- rbind(height_allo, height_allo7)
...
covs_allo$Site_Transect <- paste(covs_allo$Site, covs$Transect, sep = "_")
...
buffer_micro <- rbind(buffer_micro, buffer_micro7)
elevation_micro <- rbind(elevation_micro, elevation_micro7)
...
forest_loss_sum_micro <- rbind(forest_loss_sum_micro, forest_loss_sum_micro7)
rug_micro <- rbind(rug_micro, rug_micro7)
height_micro <- rbind(height_micro, height_micro7)
...
buffer_cheiro <- rbind(buffer_cheiro, buffer_cheiro7)
elevation_cheiro <- rbind(elevation_cheiro, elevation_cheiro7)
...
forest_loss_sum_cheiro <- rbind(forest_loss_sum_cheiro, forest_loss_sum_cheiro7)
rug_cheiro <- rbind(rug_cheiro, rug_cheiro7)
height_cheiro <- rbind(height_cheiro, height_cheiro7)
...
buffer_avahi <- rbind(buffer_avahi, buffer_avahi7)
elevation_avahi <- rbind(elevation_avahi, elevation_avahi7)
...
forest_loss_sum_avahi <- rbind(forest_loss_sum_avahi, forest_loss_sum_avahi7)
rug_avahi <- rbind(rug_avahi, rug_avahi7)
height_avahi <- rbind(height_avahi, height_avahi7)
...
buffer_lepi <- rbind(buffer_lepi, buffer_lepi7)
elevation_lepi <- rbind(elevation_lepi, elevation_lepi7)
...
forest_loss_sum_lepi <- rbind(forest_loss_sum_lepi, forest_loss_sum_lepi7)
rug_lepi <- rbind(rug_lepi, rug_lepi7)
height_lepi <- rbind(height_lepi, height_lepi7)
...
buffer_rubri <- rbind(buffer_rubri, buffer_rubri7)
elevation_rubri <- rbind(elevation_rubri, elevation_rubri7)
...
forest_loss_sum_rubri <- rbind(forest_loss_sum_rubri, forest_loss_sum_rubri7)
rug_rubri <- rbind(rug_rubri, rug_rubri7)
height_rubri <- rbind(height_rubri, height_rubri7)
...
buffer_albi <- rbind(buffer_albi, buffer_albi7)
elevation_albi <- rbind(elevation_albi, elevation_albi7)
...
forest_loss_sum_albi <- rbind(forest_loss_sum_albi, forest_loss_sum_albi7)
rug_albi <- rbind(rug_albi, rug_albi7)
height_albi <- rbind(height_albi, height_albi7)
...
buffer_prop <- rbind(buffer_prop, buffer_prop7)
elevation_prop <- rbind(elevation_prop, elevation_prop7)
...
forest_loss_sum_prop <- rbind(forest_loss_sum_prop, forest_loss_sum_prop7)
rug_prop <- rbind(rug_prop, rug_prop7)
height_prop <- rbind(height_prop, height_prop7)
...
buffer_hapa <- rbind(buffer_hapa, buffer_hapa7)
elevation_hapa <- rbind(elevation_hapa, elevation_hapa7)
...
forest_loss_sum_hapa <- rbind(forest_loss_sum_hapa, forest_loss_sum_hapa7)
rug_hapa <- rbind(rug_hapa, rug_hapa7)
height_hapa <- rbind(height_hapa, height_hapa7)
...
micro_occupancy_model <- micro_loss_detection
...
avahi_occupancy_model <- avahi_height
...
lepi_elev_detection <- occu(~scale(covars.elevation)~1, data=umf_lepi) 
...
albi_occupancy_model <- albi_full 
```
...
hapa_occupancy_model <-hapa_full
